...
#define GLIB_DEFAULT_FONT       ((GLIB_Font_t *)&GLIB_FontNumber32x40)//((GLIB_Font_t *)&GLIB_FontNormal8x8)
#endif
...
#ifndef GLIB_NO_DEFAULT_FONT
  GLIB_setFont(pContext, GLIB_DEFAULT_FONT);//set GLIB_FontNumber16x20
#endif
